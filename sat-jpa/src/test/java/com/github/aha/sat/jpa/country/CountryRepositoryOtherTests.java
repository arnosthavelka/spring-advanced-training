...
class CountryRepositoryOtherTests {
    ...
    class CollectionTests {
        ...
        /**
         * select country0_.id as id1_1_, country0_.name as name2_1_ from country
         * country0_ where (select count(cities1_.country_id) from city cities1_ where
         * country0_.id = cities1_.country_id)='Canada' order by country0_.name asc
         */
        @Test
        void size() {
            var result = new JPAQuery<>(em).select(country)
                .from(country)
                .where(country.cities.size().eq(1))
                .orderBy(country.name.asc())
                .fetch();

            assertThat(result).hasSize(7).first().satisfies(c -> {
        ...
        /**
         * select country0_.id as id1_1_, country0_.name as name2_1_ from country
         * country0_ where not (exists (select cities1_.id from city cities1_ where
         * country0_.id=cities1_.country_id)) order by country0_.name asc
         */
        @Test
        void isEmpty() {
            var result = new JPAQuery<>(em).select(country)
            ...
            assertThat(result).hasSize(1).first().satisfies(c -> {
        ...
        /**
         * select country0_.id as id1_1_, country0_.name as name2_1_ from country
         * country0_ where exists (select 1 from city cities1_ where
         * country0_.id=cities1_.country_id and cities1_.name='Barcelona')
         */
        @Test
        void any() {
            var result = new JPAQuery<>(em).select(country)
        ...
        /**
         * select country0_.id as id1_1_, country0_.name as name2_1_ from country
         * country0_ cross join city city1_ where (city1_.id in (select cities2_.id from
         * city cities2_ where country0_.id=cities2_.country_id)) and
         * city1_.name='Barcelona'
         */
        @Test
        void contains() {
            var result = new JPAQuery<>(em).select(country)
                .from(country, city)
                .where(country.cities.contains(city).and(city.name.eq("Barcelona")))
                .fetchOne();
        ...
        /**
         * select country0_.id as id1_1_, country0_.name as name2_1_ from country
         * country0_ where (select city1_.id from city city1_ where
         * city1_.name='Barcelona') in (select cities2_.id from city cities2_ where
         * country0_.id=cities2_.country_id
         */
        @Test
