...
-- EUROPE
insert into city(country, name, state) values ('Czech Republic', 'Prague', '')
insert into city(country, name, state) values ('France', 'Paris', '')
insert into city(country, name, state) values ('Spain', 'Barcelona', 'Catalunya')
insert into city(country, name, state) values ('Switzerland', 'Bern', '')
