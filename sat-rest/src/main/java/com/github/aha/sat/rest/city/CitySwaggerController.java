...
/**
 * Usage: get city detail - GET http://localhost:8080/city/swagger/105 search - GET
 * http://localhost:8080/city/swagger?country=Spain search & sort - GET
...
public class CitySwaggerController {
	...
	@Operation(summary = "Get city by ID", description = "Return the city or throw CityNotFoundException.",
			responses = {
					@ApiResponse(responseCode = "200",
							description = "Successful retrieval of city detail (full detail)"),
	...
	@Operation(summary = "Search cities", description = "Return all found cities with basic details.",
			responses = { @ApiResponse(responseCode = "200",
					description = "Successful retrieval of the list of cities (with simple detail)") })
	public List<City> search(@Parameter(name = "country", required = false) @PathParam("country") String country,
	...
	@Operation(summary = "Create a city", description = "Create a city based on data from CityBaseResource",
			responses = { @ApiResponse(responseCode = "201", description = "Successful creation of the city") })
	public void create(@Valid @RequestBody CityBaseResource resource, HttpServletRequest request,
	...
	@Operation(summary = "Update the city", description = "Update the city with the data from CityBaseResource",
			responses = { @ApiResponse(responseCode = "200", description = "Successful update of the city"),
					@ApiResponse(responseCode = "404", description = "City with given ID does not exist") })
	...
	@Operation(summary = "Delete the city", description = "Delete the city defined by ID)",
			responses = { @ApiResponse(responseCode = "204", description = "Successful deletion of the city") })
